    ...
    return (
        <div className=' bg-gray-300'>
            ...
            <div className='flex justify-center py-5'>
                <img className='h-[22rem] w-[15rem] m-5 shadow-xl shadow-blue-gray-900/50 rounded-lg object-cover' src={"http://localhost:1337" + blog.attributes.Image.data?.[0].attributes.url} alt="" />
